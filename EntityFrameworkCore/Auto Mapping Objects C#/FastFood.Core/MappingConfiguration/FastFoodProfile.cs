namespace FastFood.Core.MappingConfiguration
{
    ...
    public class FastFoodProfile : Profile
    {
        public FastFoodProfile()
        {
            ...
            //create map от какво към какво - от CategoryInputModel към Category като за името на категорията (x.Name) мапни ми я от (y.CategoryName)
            //вземи от InputModel-а подаденото отвън име на категория и го сложи в БД като име на новосъздадената категория
            ...
            this.CreateMap<Position, RegisterEmployeeViewModel>()
                ...
                .ForMember(x => x.PositionName, y => y.MapFrom(s => s.Name)); // oт RegisterEmployeeViewModel-а искам да се мапне към Id-то на самата позиция
