...
namespace RealEstates.Services
{
    public class PropertiesService : IPropertiesService
    {
        ...
        public PropertiesService(RealEstateDbContext db) //dbContext-а искаме да ни бъде подаден отвън Dipendancy Inversion, за да не се налага да коригираме навсякъде настройките /options при необходимост
        {
            this.db = db;
        }
