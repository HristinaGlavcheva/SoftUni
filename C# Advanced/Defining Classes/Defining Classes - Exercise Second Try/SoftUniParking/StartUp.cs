...
namespace SoftUniParking
{
    public class StartUp
    {
        public static void Main(string[] args)
        {
            ...
            List<string> regNumsToRemove = new List<string>();

            regNumsToRemove.Add("CC1856BG");
            regNumsToRemove.Add("EB8787MN");
            regNumsToRemove.Add("AA8787MN");

            parking.RemoveSetOfRegistrationNumber(regNumsToRemove);
